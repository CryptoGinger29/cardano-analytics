...
df_count["Total"]=(df_count["Percentage"]*32536).astype(int)

#%%

df_head=df_count.head(15)
fig=px.bar(df_head,
           x=df_head.index,
...
path=os.path.join(os.getcwd(),"providers.html")
fig.write_html(path)
...
for i in range(layers):
    ...
    ls_txsum=edge[[newmergecol,"tx_size"]].values
...
path=os.path.join(os.getcwd(),"network.html")
fig.write_html(path)